### student-admission-prediction is a application maintained for focusing on deployment. Using this application we'll deploy the application is various cloud platform
